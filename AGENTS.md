...
- `src/App.jsx` coordinates the three-mode state machine and composes the UI. `src/components/` contains the study, rest, spelling, controls, guide, and familiar-pool views; `src/hooks/useAppKeyboard.js` owns global shortcut routing.
